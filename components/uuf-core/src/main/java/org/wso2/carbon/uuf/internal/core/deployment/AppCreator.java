...
import org.wso2.carbon.uuf.internal.core.deployment.parser.DependencyNode;
...
public class AppCreator {
    ...
    public App createApp(AppReference appReference, String contextPath) {
        ...
        Map<?, ?> rawConfiguration = new ConfigurationParser().parse(appReference.getConfiguration());
        // Create Lookup.
