 ...
 * @since 1.0.0
 */
public class RenderableCreationException extends UUFRuntimeException {

    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause(Throwable)}.
     */
    public RenderableCreationException() {
    }
     ...
     */
    public RenderableCreationException(String message) {
        super(message);
    }
     ...
     */
    public RenderableCreationException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause   the cause of the exception
     */
    public RenderableCreationException(String message, Throwable cause) {
        super(message, cause);
    }
}
