...
/**
 * Indicates an error occurred when deploying an UI specific REST API.
 *
 * @since 1.0.0
 */
public class RestApiDeploymentException extends DeploymentException {

    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause(Throwable)}.
     */
    public RestApiDeploymentException() {
    }
     ...
     */
    public RestApiDeploymentException(String message) {
        super(message);
    }
     ...
     */
    public RestApiDeploymentException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause   the cause of the exception
     */
    public RestApiDeploymentException(String message, Throwable cause) {
        super(message, cause);
    }
}
