...
public class UUFRuntimeException extends RuntimeException {
     ...
     */
    public UUFRuntimeException(String message) {
        super(message);
    }
     ...
     */
    public UUFRuntimeException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause   the cause of the exception
     */
    public UUFRuntimeException(String message, Throwable cause) {
        super(message, cause);
    }
}
