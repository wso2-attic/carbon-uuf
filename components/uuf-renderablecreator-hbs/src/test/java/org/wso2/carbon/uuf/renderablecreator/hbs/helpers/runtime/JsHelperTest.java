...
public class JsHelperTest {
    ...
    public void test() {
        ...
        createRenderable("{{js \"js/bottom-script.js\"}}")
                .render(null, createLookup(), requestLookup, createAPI());
        String jsUrl = "<script src=\"/myapp/public/component/base/js/bottom-script.js\" type=\"text/javascript\">" +
                "</script>\n";

        String output = createRenderable("X {{placeholder \"js\"}} Y")
                .render(null, createLookup(), requestLookup, createAPI());
        Assert.assertEquals(output, "X " + jsUrl + " Y");
    }
    ...
    public void testWithMultipleParameters() {
        ...
        createRenderable("{{js \"js/\" \"bottom-script\" \".js\"}}")
                .render(null, createLookup(), requestLookup, createAPI());
        Assert.assertEquals(requestLookup.getPlaceholderContent(Placeholder.js).orElse(null),
                            "<script src=\"/myapp/public/component/base/js/bottom-script.js\" " +
                                    "type=\"text/javascript\"></script>\n");
    }

    @Test
    public void testWhenSameJsAddedTwice() {
        RequestLookup requestLookup = createRequestLookup();
