...
/**
 * Indicates a exception occurred when creating an {@link org.wso2.carbon.uuf.renderablecreator.hbs.core.Executable}.
 *
 * @since 1.0.0
 */
public class ExecutableCreationException extends HbsRenderableCreationException {
     ...
     */
    public ExecutableCreationException(String message) {
        super(message);
    }
     ...
     * @param cause   the cause of the exception
     */
    public ExecutableCreationException(String message, Throwable cause) {
        super(message, cause);
    }
}
